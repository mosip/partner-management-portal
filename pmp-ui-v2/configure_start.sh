...
# wget --no-check-certificate --no-cache --no-cookies $artifactory_url_env/artifactory/libs-release-local/i18n/pmp-ui-v2-i18n-bundle.zip -O $i18n_path/pmp-ui-v2-i18n-bundle.zip

# echo "unzip i18n bundle files.."
# chmod 775 $i18n_path/*

# cd $i18n_path
# unzip -o pmp-ui-v2-i18n-bundle.zip
# rm pmp-ui-v2-i18n-bundle.zip
