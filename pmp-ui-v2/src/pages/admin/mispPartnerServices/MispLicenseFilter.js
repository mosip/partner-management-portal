...
function MispLicenseFilter ({ onApplyFilter }) {
...
MispLicenseFilter.propTypes = {
    onApplyFilter: PropTypes.func.isRequired,
};

export default MispLicenseFilter;