                                                            ...
                                                            <div className="flex flex-col">
                                                                ...
                                                                <div className="flex my-[1%]">
                                                                    <div className="flex flex-col w-full">
                                                                        ...
                                                                        <input
                                                                            ...
                                                                            data-placeholder-id="oidc_edit_enter_client_name_input_placeholder"
                                                                            maxLength={256}
                                                                        />
                                                                ...
                                                                <div className="flex my-[1%]">
                                                                    <div className="flex flex-col w-full">
                                                                        ...
                                                                        <input id="oidc_edit_enter_logo_url_input" value={oidcClientDetails.logoUri} onChange={(e) => handleLogoUrlChange(e.target.value)} placeholder={t('createOidcClient.logoUrlPlaceHolder')} data-placeholder-id="oidc_edit_enter_logo_url_input_placeholder"
                                                                        ...
                                                                        {(oidcClientDetails.redirectUris).map((url, index) => (
                                                                            <div key={index} className="flex w-full justify-between items-center h-10 px-2 py-2 border border-[#707070] rounded-md text-base text-dark-blue bg-white leading-tight focus:outline-none focus:shadow-outline overflow-x-auto whitespace-nowrap no-scrollbar focus:shadow-outline mb-2">
                                                                                <input
                                                                                    ...
                                                                                    data-placeholder-id="oidc_edit_enter_redirect_url_placeholder"
