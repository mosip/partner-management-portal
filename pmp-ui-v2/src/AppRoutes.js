...
import ManualAdjudicationApiKeysList from './pages/admin/manualAdjudication/ManualAdjudicationApiKeysList.js';
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: <GuardedRoute><MainLayout><ManualAdjudicationApiKeysList /></MainLayout></GuardedRoute>,
        },
        {
