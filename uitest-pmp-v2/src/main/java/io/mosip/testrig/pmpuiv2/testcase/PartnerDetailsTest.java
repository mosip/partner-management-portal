...
public class PartnerDetailsTest extends BaseClass {
	...
	public void partnerIndividualDetailsVerification() {
		...
		assertTrue(partnerAdmin.isPartnerTypeInViewPartnerPageDisplayed(), GlobalConstants.isPartnerTypeInViewPartnerPageDisplayed);
		assertTrue(partnerAdmin.isDeviceProviderInViewPartnerPageDisplayed(), GlobalConstants.isDeviceProviderInViewPartnerPageDisplayed);
        ...
        assertTrue(partnerAdmin.isOriginalCertificateDropdownDisplayed(), GlobalConstants.isOriginalCertificateDropdownDisplayed);
        assertTrue(partnerAdmin.isMosipSignedCertificateDropdownDisplayed(), GlobalConstants.isMosipSignedCertificateDropdownDisplayed);
        partnerAdmin.clickOnOriginnalCertificateInViewPartnerPage();
        assertTrue(partnerAdmin.isSuccessMassageInOriginalCertificateDisplayed(), GlobalConstants.isSuccessMassageInOriginalCertificateDisplayed);
        partnerAdmin.clickOnMosipSignedCertificateInViewPartnerPage();
        assertTrue(partnerAdmin.isSuccessMassageInMosipSignedCertificateDisplayed(), GlobalConstants.isSuccessMassageInMosipSignedCertificateDisplayed);
        assertTrue(partnerAdmin.isGobackButtonInViewPatnerPageDisplayed(), GlobalConstants.isGobackButtonInViewPatnerPageDisplayed);
        partnerAdmin.clickOngobackButtonInPartnerDetailsPage();
        assertTrue(partnerAdmin.isSubTitleListDisplayed(), GlobalConstants.isSubTitleListDisplayed);
