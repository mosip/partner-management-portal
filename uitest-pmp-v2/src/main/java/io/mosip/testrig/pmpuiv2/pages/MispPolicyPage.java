...
public class MispPolicyPage extends BasePage {
    ...
    private WebElement editMispPolicyPage;
    ...
    @FindBy(id = "page_title")
    private WebElement viewPolicyPage;
    ...
    public void clickOnActionOfMispPolicy(String policyName) {
        By threeDotsButton = By.xpath(
                "//td[text()='" + policyName + "']/parent::tr//button[contains(@id,'policies_list_view')]"
        );
    ...
    public boolean isEditMispPolicyPageDisplayed() {
        return isElementDisplayed(editMispPolicyPage);
    }
    ...
    public boolean isViewPolicyPageDisplayed() {
        return isElementDisplayed(viewPolicyPage);
    }
