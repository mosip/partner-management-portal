...
public class ConfigManager {
	...
	public static void init() {
		...
		iamExternalURL = System.getenv(IAM_EXTERNAL_URL) == null ? propsKernel.getProperty(IAM_EXTERNAL_URL)
		...
		String systemPropertyTestcases = System.getProperty(Testcases);
		testcases = systemPropertyTestcases != null ? systemPropertyTestcases
	...
	public static int getTimeout() {
	    try {
	        return Integer.parseInt(propsKernel.getProperty("explicitWaitTimeout", "30"));
