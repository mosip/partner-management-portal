...
public class GlobalConstants {
	...
	public static final String isIntCAIssuedByContextDisplayed = "Verify if int ca issued by context displayed";
	...
	public static final String isAuthPolicyTabInCreatePolicyGroupDisplayed = "Verify if auth policytab isdisplayed";
	public static final String isDataSharePolicyTabInCreatePolicyGroupDisplayed = "Verify if datashare isdisplayed";
	...
	public static final String isCancelBtnInCreatePolicyGroupDisplayed = "Verify if cancel button isdisplayed";
	public static final String isSubmitBtnInCreatePolicyGroupDisplayed = "Verify if submit button isdisplayed";
	public static final String isPolicyGroupIdHeaderDisplayed = "Verify if policy group header isdisplayed";
	public static final String isPolicyGroupNameheaderDisplayed = "Verify if policy group name isdisplayed";
	public static final String isPolicyGroupsDescriptionDisplayed = "Verify if policy group description  isdisplayed";
	public static final String isCreationHeaderDisplayed = "Verify if creation header isdisplayed";
	public static final String isStatusHeadersDisplayed = "Verify if status header isdisplayed";
	public static final String isActionsHeaderDisplayed = "Verify if action header isdisplayed";
	public static final String isCreateAuthPartnerHeaderDisplayed = "Verify if create auth partner isdisplayed";
	public static final String isListOfAuthenticationPolicesTitleDisplayed = "Verify if authentication policy title isdisplayed";
	public static final String isAuthPolicyMessageDisplayed = "Verify if authentication massage isdisplayed";
	public static final String isAuthPolicyGroupDropDownDisplayed = "Verify if auth policy group drop down isdisplayed";
	public static final String isUploadButtonInAuthPolicyDisplayed = "Verify if auth policy upload button isdisplayed";
	public static final String isCancelButtonInAuthPolicyDisplayed = "Verify if cancel  auth policy button isdisplayed";
	public static final String isSaveAsDraftButtonInAuthPolicyDisplayed = "Verify if save as draft auth policy button isdisplayed";
	public static final String isPolicyIdHeaderInAuthPolicyDisplayed = "Verify if policy id header id isdisplayed";
	public static final String isPolicyNameHeaderInAuthPolicyDisplayed = "Verify if policy name header isdisplayed";
	public static final String isPolicyDescriptionInAuthPolicyDisplayed = "Verify if policy description auth policy button isdisplayed";
