...
public class GlobalConstants {
	...
	public static final String isSideNavPartnerCertificateDisplayed = "Verify Partner Certificate side panel item is displayed for Credential Partner";
	public static final String isSideNavPoliciesDisplayed = "Verify Policies side panel item is displayed for Credential Partner";
	public static final String isSidePanelPartnerCertificateNavigationSuccessful = "Verify side panel Partner Certificate navigation opens the Partner Certificate page";
	public static final String isSidePanelPoliciesNavigationSuccessful = "Verify side panel Policies navigation opens the Policies page";
	public static final String isSidePanelHomeNavigationSuccessful = "Verify side panel Home navigation returns to the Dashboard";
	public static final String isHamburgerMenuExpanded = "Verify hamburger menu expands when hamburger icon is clicked";
	public static final String isHamburgerMenuCollapsed = "Verify hamburger menu collapses when hamburger icon is clicked again";
	public static final String isOrganisationNamePersistedAcrossScreens = "Verify organisation name persists across Credential Partner screens";
	public static final String isUserNamePersistedAcrossScreens = "Verify user name persists across Credential Partner screens";
	public static final String isUserProfilePageDisplayed = "Verify My Profile page is displayed after clicking User Profile from dashboard";
	public static final String isUserProfileDetailsMatchingRegisteredData = "Verify user profile details match the registered Credential Partner data";
	public static final String isCredentialPartnerLoggedOutSuccessfully = "Verify Credential Partner is logged out successfully and login page is displayed";
	public static final String isFrenchLanguageSelectedOnSignIn = "Verify French language is selected from the sign-in page language dropdown";
	public static final String isArabicLanguageSelectedOnSignIn = "Verify Arabic language is selected from the sign-in page language dropdown";
	public static final String isCredentialPartnerFrenchLoginSuccessful = "Verify Credential Partner login succeeds after selecting French on sign-in page";
	public static final String isCredentialPartnerArabicLoginSuccessful = "Verify Credential Partner login succeeds after selecting Arabic on sign-in page";
	public static final String isFrenchWelcomeMessageDisplayed = "Verify French welcome message is displayed on Dashboard after French login";
	public static final String isArabicWelcomeMessageDisplayed = "Verify Arabic welcome message is displayed on Dashboard after Arabic login";
	public static final String isFrenchDashboardCardsDisplayed = "Verify Credential Partner dashboard cards are displayed in French";
	public static final String isArabicDashboardCardsDisplayed = "Verify Credential Partner dashboard cards are displayed in Arabic";
	public static final String isFrenchPagesAndHeadersDisplayed = "Verify Credential Partner pages and headers are displayed in French";
	public static final String isArabicPagesAndHeadersDisplayed = "Verify Credential Partner pages and headers are displayed in Arabic";
	public static final String isFrenchProfileDetailsDisplayed = "Verify Credential Partner profile labels and details are displayed in French";
	public static final String isArabicProfileDetailsDisplayed = "Verify Credential Partner profile labels and details are displayed in Arabic";

	public static final String FRENCH_PARTNER_CERTIFICATE_TITLE = "Certificat de partenaire";
	public static final String FRENCH_PARTNER_CERTIFICATE_DESC = "Téléchargez, téléchargez à nouveau, téléchargez et affichez les détails du certificat.";
	public static final String FRENCH_POLICIES_TITLE = "Stratégies";
	public static final String FRENCH_POLICIES_DESC = "Demandez et consultez vos polices";
	public static final String FRENCH_MY_PROFILE_TITLE = "Mon profil";
	public static final String FRENCH_CREDENTIAL_PARTNER_TYPE = "Partenaire d'identification";
	public static final String FRENCH_FIRST_NAME_LABEL = "Prénom";
	public static final String FRENCH_LAST_NAME_LABEL = "Nom de famille";
	public static final String FRENCH_ORG_NAME_LABEL = "Nom de l'organisme";
	public static final String FRENCH_PARTNER_TYPE_LABEL = "Type de partenaire";
	public static final String FRENCH_USER_NAME_LABEL = "Nom d'utilisateur";

	public static final String ARABIC_PARTNER_CERTIFICATE_TITLE = "شهادة الشريك";
	public static final String ARABIC_PARTNER_CERTIFICATE_DESC = "تحميل الشهادة وإعادة تحميلها وتنزيلها وعرض تفاصيل الشهادة.";
	public static final String ARABIC_POLICIES_TITLE = "سياسات";
	public static final String ARABIC_POLICIES_DESC = "طلب وعرض السياسات الخاصة بك.";
	public static final String ARABIC_MY_PROFILE_TITLE = "ملفي الشخصي";
	public static final String ARABIC_CREDENTIAL_PARTNER_TYPE = "شريك الاعتماد";
	public static final String ARABIC_FIRST_NAME_LABEL = "الاسم الأول";
	public static final String ARABIC_LAST_NAME_LABEL = "اسم العائلة";
	public static final String ARABIC_ORG_NAME_LABEL = "اسم المنظمة";
	public static final String ARABIC_PARTNER_TYPE_LABEL = "نوع الشريك";
	public static final String ARABIC_USER_NAME_LABEL = "اسم المستخدم";
	public static final String ARABIC_WELCOME_PREFIX = "مرحباً";
