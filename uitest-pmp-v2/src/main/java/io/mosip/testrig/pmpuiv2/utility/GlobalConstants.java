...
public class GlobalConstants {
	...
	public static final String isUploadButtonClickableForFirstTimeCertificate = "Verify Upload button is clickable for first-time partner certificate";
	public static final String isOnlyUploadButtonAvailableWhenNoCertificateExists = "Verify only Upload button is available when no partner certificate exists";
	public static final String isCredentialPartnerCertificateUploadedSuccessfully = "Verify valid partner certificate is uploaded successfully for Credential Partner";
	public static final String RE_UPLOAD_BUTTON_LABEL = "Re-Upload";
	public static final String UPLOAD_PARTNER_CERTIFICATE_POPUP_TITLE = "Upload Partner Certificate";
	...
	public static final String CERTIFICATE_UPLOAD_SELECT_TEXT = "Please tap to select the certificate";
	public static final String CERTIFICATE_UPLOAD_FORMAT_TEXT = "Only .cer or .pem certificate formats are allowed for upload";
	public static final String CERTIFICATE_UPLOAD_SECTION_DISPLAY_TEXT = "Please tap to select the certificate. Only .cer or .pem certificate formats are allowed for upload";
	...
	public static final String FETCHING_CERTIFICATE_MESSAGE = "We’re fetching your certificate...";
	public static final String ROOT_CA_INTERMEDIATE_CA_NOT_FOUND_MESSAGE = "Root CA/Intermediate CA Certificates not found.";
	public static final String isOnlyCerAndPemFilesAcceptedByDefault = "Verify only .cer and .pem files are visible/selectable by default";
	public static final String isUnsupportedCertificateFormatErrorOnUpload = "Verify upload of unsupported file format shows correct error message";
	public static final String isSubmitButtonDisabledByDefault = "Verify Submit button is disabled by default";
	public static final String isSubmitEnabledOnlyAfterRequiredConditionsMet = "Verify Submit button is enabled only after all required conditions are met";
	public static final String isProgressIndicatorShownDuringCertificateFetch = "Verify progress indicator is shown during certificate fetch";
	public static final String isFetchingMessageDisplayedDuringCertificateFetch = "Verify fetching message is displayed during certificate fetch";
	public static final String isCancelOptionAvailableDuringCertificateFetch = "Verify Cancel option is available during certificate fetch";
	public static final String isRemoveOptionDisplayedAfterCertificateFetch = "Verify Remove option is displayed after certificate fetch";
	public static final String isRootCaIntermediateCaNotFoundErrorDisplayed = "Verify error when CA certificate is not present in system";
	public static final String isPartnerCertificateReplacedOnReUpload = "Verify existing certificate is replaced during re-upload";
	...
	public static final String isReUploadWithSameCertificateFileSuccessful = "Verify Re-Upload with same certificate file allows replacement";
	public static final String isCertificateDetailsDisplayedBeforeReUpload = "Verify certificate details are displayed before Re-Upload";
	public static final String isCertificateDetailsRefreshedAfterSameFileReUpload = "Verify certificate details are refreshed after Re-Upload with same certificate file";
	...
	public static final String isUserInfoResponseTypeOptionsCorrect = "Verify User Info Response Type dropdown contains options JWS and JWE";
	public static final String isUserInfoResponseTypeInfoTooltipCorrect = "Verify Info icon text for User Info Response Type";
	public static final String isPurposeTypeDropdownDisplayed = "Verify Purpose Type dropdown is visible";
	public static final String isPurposeTypePlaceholderDisplayed = "Verify Purpose Type dropdown displays placeholder “Select Purpose Type.”";
	public static final String isPurposeTypeOptionsCorrect = "Verify Purpose Type dropdown contains the options Login, Link, Verify";
	public static final String isPurposeTitleSubtitleHiddenWhenNoPurposeTypeSelected = "Verify Purpose Title & Purpose Subtitle fields remain hidden when no Purpose Type is selected";
	public static final String isPurposeTitleSubtitleDisplayedWhenPurposeTypeSelected = "Verify Purpose Title & Subtitle appear when any Purpose Type option is selected";
	public static final String isSubmitAllowedWithoutPurposeTypeSelected = "Verify user can submit form without selecting Purpose Type";
	public static final String isNoPurposeTitleSubtitleRowsVisibleByDefault = "Verify no rows are visible by default for Purpose Title and Purpose Subtitle";
	public static final String isPurposeTitleLanguageDropdownContainsDefaultAndAllLanguages = "Verify Language Dropdown Contains Default and All Supported Languages";
	public static final String isPurposeTitleSubtitleTextBoxDisplayed = "Verify Text Box is Displayed for Title/Subtitle";
	public static final String isPurposeTitlePlaceholderCorrect = "Verify Placeholder for Purpose Title";
	public static final String isPurposeSubtitlePlaceholderCorrect = "Verify Placeholder for Purpose Subtitle";
	public static final String isAdditionalRowsExcludeAlreadyUsedLanguages = "Verify additional rows can be added for more languages (excluding already used codes)";
	public static final String isSubmitAllowedWithOnlyPurposeTitleFilled = "Verify Partner can add only Purpose Title and leave Purpose Subtitle blank";
	public static final String isSubmitAllowedWithOnlyPurposeSubtitleFilled = "Verify Partner can add only Purpose Subtitle and leave Purpose Title blank";
	public static final String isSubmitBlockedWhenLanguageRowTextEmpty = "Verify text cannot be empty for any added language row";
	public static final String isMultilingualWithPurposeFieldsSubmitSuccessful = "Verify Partner creates an OIDC Client with multilingual Client Name, Purpose Title, and Purpose Subtitle";
	public static final String isBlankPurposeTitleSubtitleSubmitSuccessful = "Verify the Partner leaves both Purpose Title and Purpose Subtitle blank";
	public static final String isConfirmationDescriptionMessageCorrect = "Verify the confirmation pop-up displays the correct description message after successful OIDC Client submission";
	public static final String isLegacyOnlySubmitSuccessfulWithoutRegression = "Verify existing backend integrations and validations remain unchanged";
	public static final String isPartnerTypeAutoPopulatedAndReadOnly = "Verify Partner Type auto-populates when Partner ID is selected";
	public static final String isPolicyGroupAutoPopulatedAndReadOnly = "Verify Policy Group auto-populates based on selected Partner ID";
	public static final String isNoLanguageValidationForMultilingualText = "Verify no language validation for multilingual text fields";
