...
public class LogUtil {
	...
	public static String describeElement(By locator) {
	...
	public static void step(String message) {
		String formatted = "➡️  STEP: " + message;
		logger.info(formatted);
		logToReporter(formatted, "grey");
	}
	...
	public static void verify(String message, By locator) {
		String fullMessage = "🔍 VERIFY: " + message + ": " + describeElement(locator);
		logger.info(fullMessage);
		Reporter.log("<br><span style='color:darkorange;'>" + fullMessage + "</span>", false);
	}
