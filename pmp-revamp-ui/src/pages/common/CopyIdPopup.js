            ...
            <FocusTrap focusTrapOptions={{ initialFocus: false, allowOutsideClick: true }}>
                <div className={`bg-white md:w-[378px] w-[40%] mx-auto rounded-lg shadow-lg h-fit`}>
                    <header className={`flex justify-between p-[5%]`}>
                        ...
                        <img role='button' id='copy_id_close_btn' src={close_icon} alt="" onClick={dismiss} className={`h-7 cursor-pointer max-[450px]:h-4 ${isLoginLanguageRTL ? "pr-2 " : "pl-2"}`} tabIndex="0" onKeyDown={(e) => onPressEnterKey(e, dismiss)} />
                    </header>
                    <hr className={`py-[3.5%]`} />
