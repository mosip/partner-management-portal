                                                        ...
                                                        {oidcClientsList.map((client, index) => {
                                                            return (
                                                                <tr id={"oidc_client_list_item" + (index + 1)} key={index}
                                                                    ...
                                                                    <td onClick={() => client.status !== 'INACTIVE' && viewOidcClientDetails(client)} className="px-2">{formatDate(client.createdDateTime, "date", true)}</td>
                                                                    ...
                                                                    <td className="px-2 mx-2 cursor-default">
                                                                        <div className="flex items-center justify-center">
                                                                            <svg className="cursor-pointer" id={'oidc_show_copy_popup_btn' + (index + 1)} onClick={() => openClientIdPopUp(client)} tabIndex="0" onKeyDown={(e) => onPressEnterKey(e, () => openClientIdPopUp(client))}
