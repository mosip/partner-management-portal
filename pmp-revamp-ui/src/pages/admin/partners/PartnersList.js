...
function PartnersList() {
  ...
  const tableHeaders = [
    { id: 1, keyName: 'partnerId', headerNameKey: "partnerList.partnerId" },
    { id: 2, keyName: 'partnerType', headerNameKey: "partnerList.partnerType" },
    { id: 3, keyName: 'orgName', headerNameKey: "partnerList.organisation" },
    { id: 4, keyName: 'policyGroupName', headerNameKey: "partnerList.policyGroup" },
    { id: 5, keyName: 'emailAddress', headerNameKey: "partnerList.email" },
    { id: 6, keyName: 'certificateUploadStatus', headerNameKey: "partnerList.certUploadStatus" },
    { id: 7, keyName: 'status', headerNameKey: "partnerList.status" },
    { id: 8, keyName: 'action"', headerNameKey: "partnerList.action" },
  ];
