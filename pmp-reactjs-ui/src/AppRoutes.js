...
import AuthenticationServices from './pages/authenticationServices/AuthenticationServices.js';
import OidcClientList from './pages/authenticationServices/OidcClientList.js';
  ...
  const router = createHashRouter([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'authenticationServices/oidcClient',
          element: <GuardedRoute><MainLayout><AuthenticationServices><OidcClientList/></AuthenticationServices></MainLayout></GuardedRoute>,
        },
        {
          path: 'authenticationServices/apiKey',
          element: <GuardedRoute><MainLayout><AuthenticationServices><ApiKeysList/></AuthenticationServices></MainLayout></GuardedRoute>,
        },
        {
          path: 'generateApiKey',
