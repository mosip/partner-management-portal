                                            ...
                                            <div className="space-y-6">
                                                <div className="my-4">
                                                    <div className="flex flex-col w-[48%] max-[450px]:w-full">
                                                        ...
                                                        <input value={policyGroupName} onChange={(e) => onChangePolicyGroupName(e.target.value)}
                                            ...
                                            <div className="space-y-6">
                                                <div className="my-4">
                                                    <div className="flex flex-col w-full max-[450px]:w-full">
                                                        ...
                                                        <textarea value={policyGroupDesc} onChange={(e) => onChangePolicyGroupDesc(e.target.value)}
