...
function DownloadJsonPopup({ title, closePopUp, jsonData }) {
            ...
            <div className='flex-col bg-white w-[45rem] min-h-[6rem] rounded-md relative top-[2.5rem]'>
                <div className='flex py-2 px-5 justify-between items-center'>
                    ...
                    <div className='flex gap-x-9 items-center'>
                        <button className='text-xs px-[1.3rem] py-[0.8%] border font-normal rounded-md h-9 w-fix text-tory-blue bg-white border-blue-800 cursor-pointer'>
                            {t('commons.download')}
                        </button>
