        ...
        <div className={`mt-2 w-[100%] ${isLoginLanguageRTL ? "mr-28 ml-5" : "ml-28 mr-5"} overflow-x-scroll font-inter`}>
            ...
            <div className="flex-col mt-7">
                <div className="flex justify-between">
                    <Title title='createPolicyGroup.createPolicyGroup' subTitle='createPolicyGroup.policies' backLink={'/partnermanagement/admin/policies/policyGroupList'} style={style} />
                </div>
