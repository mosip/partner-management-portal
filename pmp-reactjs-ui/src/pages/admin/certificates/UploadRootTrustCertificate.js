...
function UploadRootTrustCertificate() {
    ...
    const uploadCertificateDropdownStyle = {
        dropdownButton: "!text-light-grat !w-[23rem] !h-[3rem] !text-lg",
    }
            ...
            <div className="flex-col mt-7">
                ...
                <div className="flex-col justify-center mt-3 h-full">
                    <div className="w-[100%] bg-snow-white rounded-lg shadow-md p-[1%]">
                        ...
                        <div className={`flex-col my-6 text-center`}>
                            <h1 className='font-semibold text-md text-dark-blue'>{t('uploadRootofTrustCertificate.uploadRootofTrustCertificate')}</h1>
                            <p className='text-md text-light-gray'>{t('uploadRootofTrustCertificate.uploadRootofTrustCertificateDesc')}</p>
                        </div>
                        <div className='flex-col'>
                            <div className='flex justify-center'>
                                <div className='outline-[#1447b2] outline-offset-2 outline-2 rounded-md outline-dashed'>
                                    <div className={`flex-col p-[2rem] border-2 bg-[#f9fafb] my-5 mx-4 rounded-xl`}>
                                        <DropdownComponent
                            ...
                            <div className={`flex flex-row max-[450px]:flex-col space-x-3 max-[450px]:space-x-0 max-[450px]:space-y-2 max-[650px]:flex-col w-full md:w-auto justify-end p-[1rem]`}>
                                <button id="upload_admin_certificate_cancel_btn" onClick={cancelUpload} className={`${isLoginLanguageRTL ? "ml-2" : "mr-2"} w-[10%] max-[650px]:w-[15%] h-10 border-[#1447B2] border rounded-md bg-white text-tory-blue text-sm font-semibold`}>{t('commons.cancel')}</button>
                                <button disabled={!fileName} id="upload_admin_certificate_btn" onClick={submit} className={`${isLoginLanguageRTL ? "ml-2" : "mr-2"} w-[10%] max-[650px]:w-[15%] h-10 ${!uploadSuccess ? 'bg-[#a9abae] border-[#b1b3b6] text-[#f9fafa]' : 'border-[#1447B2] bg-tory-blue text-white'}  border rounded-md text-sm font-semibold`}>{t('commons.submit')}</button>
                            </div>
                        </div>
                    </div>
                </div>
