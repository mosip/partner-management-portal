...
import { getPartnerManagerUrl, handleServiceErrors, moveToOidcClientsList } from "../../utils/AppUtils";
                        ...
                        <div className="w-[100%] bg-snow-white mt-[1.5%] rounded-lg shadow-md">
                            ...
                            <div className="flex flex-row px-[3%] py-5 justify-between max-[400px]:flex-col">
                                ...
                                <div className={`flex flex-row space-x-3 w-full md:w-auto justify-end`}>
                                    <button onClick={() => moveToOidcClientsList(navigate)} className={`${isLoginLanguageRTL ? "ml-2" : "mr-2"} w-11/12 md:w-40 h-10 border-[#1447B2] border rounded-md bg-white text-tory-blue text-sm font-semibold`}>{t('requestPolicy.cancel')}</button>
