        ...
        <div className={`mt-5 w-[100%]  ${isLoginLanguageRTL ? "mr-28 ml-5" : "ml-28 mr-5"} font-inter`}>
            <div className="flex-col">
                <div className={`flex items-start space-x-3`}>
                    <img src={backArrow} onClick={() => moveToApiKeysList(navigate)} alt="" className={`cursor-pointer max-[450px]:h-3 ${isLoginLanguageRTL ? "ml-2" :""} mt-[1%] max-[450px]:mt-[3%]`} />
                    <div className="flex-col">
                        <h1 className="font-semibold text-xl text-dark-blue max-[450px]:text-sm">{t('generateApiKey.generateApiKey')}</h1>
                ...
                <div className="flex items-center justify-center w-[100%] h-[480px] bg-snow-white mt-[1.5%] rounded-lg shadow-md">
                    <div className="flex-col justify-center items-center">
                        <div className="text-center">
                            <img src={successIcon} alt="" className={`${isLoginLanguageRTL ? "mr-28 max-[450px]:mr-20" : "ml-24 max-[450px]:ml-20"} h-40`} />
                            ...
                            <div className={`flex gap-x-3 mt-12 max-[450px]:flex-col max-[450px]:gap-x-0 ${isLoginLanguageRTL ? "justify-center" :"justify-center"}`}>
                                <button onClick={() => moveToApiKeysList(navigate)} type="button" className="text-white font-semibold bg-tory-blue rounded-md text-sm px-12 py-4 max-[450px]:text-xs max-[450px]:mx-6 max-[450px]:mb-2">
                                    {t('commons.goBack')}
                                </button>
