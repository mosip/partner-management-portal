                    ...
                    <div className="flex-col justify-center">
                        ...
                        <div className="text-center">
                            ...
                            <div className="flex space-x-3 mt-12 justify-center">
                                ...
                                <button onClick={() => moveToHome(navigate)} type="button" className={`${isLoginLanguageRTL && '!mr-2'} text-[#1447b2] font-semibold bg-white border border-[#1447b2] rounded-md text-base px-12 py-4`}>
                                {t('commons.home')}
                                </button>
                            </div>
                        </div>
