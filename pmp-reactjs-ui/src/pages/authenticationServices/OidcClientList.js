...
function OidcClientList({ activeOidcClient, listOfOidcClients }) {
  ...
  useEffect(() => {
    const sortedData = listOfOidcClients.sort((a, b) => new Date(b.crDtimes) - new Date(a.crDtimes));
