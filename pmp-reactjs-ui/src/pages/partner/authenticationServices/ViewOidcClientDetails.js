...
import { isLangRTL, handleMouseClickForDropdown, getGrantTypes, bgOfStatus, onPressEnterKey, copyOidcClientId } from "../../../utils/AppUtils";
                ...
                <div className="bg-snow-white h-fit mt-1 rounded-t-xl shadow-lg font-inter">
                    <div className="flex justify-between px-7 pt-3 border-b max-[450px]:flex-col">
                        ...
                        <div id="oidc_client_details_copy_id" className={`${oidcClientDetails.status === "ACTIVE" ? 'bg-[#F0F5FF] border-[#BED3FF] cursor-pointer hover:shadow-md' : 'bg-gray-200 border-gray-400'}  border h-[4%] w-[15%] max-[450px]:w-[40%] max-[800px]:w-[25%] ${isLoginLanguageRTL ? "pr-[3%] pl-[1.5%]" : "pl-[3%] pr-[1%]"} py-[0.5%] rounded-md text-right`}
                         tabIndex="0" onKeyPress={(e)=>onPressEnterKey(e, copyOidcClientId(oidcClientDetails, oidcClientDetails.clientId, setCopied))}>
                            ...
                            <div className="flex space-x-1 items-center">
                                ...
                                {oidcClientDetails.status === "ACTIVE" ? (
                                    <img id="oidc_client_details_copy_id_icon" src={content_copy_icon} alt="" onClick={() => copyOidcClientId(oidcClientDetails, oidcClientDetails.clientId, setCopied)}/>
                                ) : (
