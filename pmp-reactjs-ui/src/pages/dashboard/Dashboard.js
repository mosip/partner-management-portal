      ...
      {dataLoaded && (
        <>
          ...
          <div className="flex mt-2 ml-[3.2%] flex-wrap break-words">
            ...
            <div onClick={() => authenticationServices()} className="w-[23.5%] min-h-[50%] p-6 mr-3 mb-4 pt-16 bg-white border border-gray-200 shadow cursor-pointer  text-center rounded-xl">
              <div className="flex justify-center mb-5">
