function SortingIcon ({ headerId, sortDescOrder, sortAscOrder, order, activeSortDesc, activeSortAsc}) {
    return (
        <div>
            <svg className="cursor-pointer mx-2 mb-0.5" onClick={() => sortDescOrder(headerId)} alt="Descending"
            ...
            <svg className="cursor-pointer mx-2" onClick={() => sortAscOrder(headerId)} alt="Ascending"
                xmlns="http://www.w3.org/2000/svg"
                width="8" height="8" viewBox="0 0 7 6">
