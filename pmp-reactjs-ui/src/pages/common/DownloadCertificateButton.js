        ...
        <div ref={downloadDropdownRef} className={`flex-col`}>
            ...
            {showDropDown && (
                <div className={styleSet && styleSet.outerDiv}>
                    <div id={'original_certificate_download_btn' +  (index+1)} onClick={() => onClickFirstOption(requiredData)} className="flex items-center border-b justify-between cursor-pointer hover:bg-gray-100">
