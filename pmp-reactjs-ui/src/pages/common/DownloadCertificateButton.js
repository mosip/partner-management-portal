        ...
        <div ref={downloadDropdownRef} className={`flex-col`}>
            ...
            {showDropDown && (
                <div className={styleSet && styleSet.outerDiv}>
                    ...
                    <div onClick={() => onClickSecondOption(requiredData)} className={`flex items-center justify-between ${requiredData.disableSecondOption ? 'hover:bg-none':'hover:bg-gray-100 cursor-pointer'}`}>
