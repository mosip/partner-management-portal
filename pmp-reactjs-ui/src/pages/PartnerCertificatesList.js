        ...
        <div className=" flex-col w-full p-5 bg-anti-flash-white h-full font-inter">
            <div className="flex-col ml-1">
                ...
                <ul className="min-w-3.5 bg-white mt-3 rounded-lg shadow-md p-5 mr-8 pb-20">
                    {certificatesData.length === 0 ? <p className="mt-5 ml-4 font-inter text-xs tracking-tight text-gray-600"> No partner types are mapped to your user id</p> :
                                ...
                                <li key={index} className="rounded-lg shadow-lg border mb-6">
                                    ...
                                    <div className="flex items-center p-5 bg-white">
                                        ...
                                        <div className="flex-col ml-12">
                                            ...
                                            <p className="font-semibold text-sm text-red-950">{partner.certificateExpiryDate ? partner.certificateExpiryDate : '-'}</p>
                                        </div>
                                        <div className="flex-col ml-36">
                                            <p className="font-medium text-xs text-gray-400">Time of Upload</p>
                                            <p className="font-semibold text-sm text-red-950">{partner.certificateUploadDate ? partner.certificateUploadDate : '-'}</p>
                                        </div>
                                    </div>
                                </li>
                            )
