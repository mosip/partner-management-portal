...
public class PolicyGroupPage extends BasePage{
	...
	@FindBy(xpath = "//*[contains(text(), 'List of Policy Groups')]")
	...
	private WebElement policyGroupDeactivateButton;
	...
	@FindBy(xpath = "//p[text()='Ab12Cd2E4f']")
	...
	public void enterPolicyGroupName(String value) {
		enter(policyGroupNameTextbox,value);
	}
	
	public void enterPolicyGroupNameDescription(String value) {
		enter(policyGroupNameDescriptionTextbox,value);
	}
	...
	public boolean isPolicyGroupDeactivateButtonDisplayed() {
		return isElementDisplayed(policyGroupDeactivateButton);
	}
	...
	public void clickOnPolicyGroupDeactivateButton() {
		clickOnElement(policyGroupDeactivateButton);
	}
