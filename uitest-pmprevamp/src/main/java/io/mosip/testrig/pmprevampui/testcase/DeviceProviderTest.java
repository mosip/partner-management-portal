...
//		// deviceProviderPage.clickOnNavigationAlertCancel();
	...
	public void AddAndVerifyDeviceInSbi() {
		...
		listOfSbiPage.clickOnAddDeviceButton(GlobalConstants.AUTOMATION);		
		...
		fillDeviceDetails(GlobalConstants.FACE, GlobalConstants.FULL_FACE, GlobalConstants.AUTOMATION, GlobalConstants.AUTOMATION);
		addDevicePage.clickOnClear();
		assertEquals(addDevicePage.getDeviceTypeValue(), GlobalConstants.INITIAL_DEVICE_TYPE);
		...
		addDevices(GlobalConstants.FACE, GlobalConstants.FULL_FACE, GlobalConstants.AUTOMATION, GlobalConstants.AUTOMATION);
		verifyAddDeviceLabelsAndPageDetails();
		
		assertTrue(addDevicePage.isDeleteButtonEnabled(), GlobalConstants.isDeleteButtonEnabled);
		
		addDevices(GlobalConstants.FINGER, GlobalConstants.SINGLE, GlobalConstants.CHARACTERS_36, GlobalConstants.CHARACTERS_36);
		addDevices(GlobalConstants.FINGER, GlobalConstants.SLAP, GlobalConstants.CHARACTERS_1, GlobalConstants.CHARACTERS_1);
		addDevices(GlobalConstants.FINGER, GlobalConstants.TOUCHLESS, GlobalConstants.ALPHANUMERIC, GlobalConstants.ALPHANUMERIC);
		addDevices(GlobalConstants.IRIS, GlobalConstants.SINGLE, GlobalConstants.ALPHANUMERIC_AND_SYMBOLS, GlobalConstants.ALPHANUMERIC_AND_SYMBOLS);
		addDevices(GlobalConstants.IRIS, GlobalConstants.DOUBLE, GlobalConstants.SINGLE_NUMERIC, GlobalConstants.SINGLE_NUMERIC);
		addDevices(GlobalConstants.FINGER, GlobalConstants.SINGLE, GlobalConstants.AUTOMATION_UPPERCASE, GlobalConstants.AUTOMATION_UPPERCASE);
		addDevices(GlobalConstants.IRIS, GlobalConstants.SINGLE, GlobalConstants.AUTOMATION_LOWERCASE, GlobalConstants.AUTOMATION_LOWERCASE);
		addDevices(GlobalConstants.FINGER, GlobalConstants.SLAP, GlobalConstants.SPECIAL_CHARACTERS, GlobalConstants.SPECIAL_CHARACTERS);
		addDevices(GlobalConstants.FINGER, GlobalConstants.TOUCHLESS, GlobalConstants.ALPHANUMERIC, GlobalConstants.AUTOMATION);
		addDevices(GlobalConstants.FINGER, GlobalConstants.TOUCHLESS, GlobalConstants.AUTOMATION, GlobalConstants.ALPHANUMERIC);
		
		fillDeviceDetails(GlobalConstants.FACE, GlobalConstants.FULL_FACE, GlobalConstants.NUMERIC, GlobalConstants.NUMERIC);
		addDevicePage.clickOnDeleteButton();
		addDevicePage.clickOnBackToDevices();
		
		assertEquals(listOfDevicesPage.isAddedDeviceDisplayed(GlobalConstants.FACE, GlobalConstants.FULL_FACE, GlobalConstants.NUMERIC, GlobalConstants.NUMERIC), false);
		listOfDevicesPage.clickOnDeviceThreeDots(GlobalConstants.FINGER, GlobalConstants.SLAP, GlobalConstants.CHARACTERS_1, GlobalConstants.CHARACTERS_1);
	...
	public void verifySbiDevice() {
		...
		assertTrue(listOfSbiPage.isDevicePendingForApprovalCountDisplayed(), GlobalConstants.isDevicePendingForApprovalCountDisplayed);
		...
		assertTrue(listOfSbiPage.isDeactivatedStatusDisplayed(GlobalConstants.ALPHANUMERIC), GlobalConstants.isStatusDisplayed);
	...
	private void verifyAddDeviceLabelsAndPageDetails() {
		...
		assertTrue(addDevicePage.isSbiVersionDisplayed(GlobalConstants.AUTOMATION), GlobalConstants.isSbiVersionDisplayed);
	...
	private void addDevices(String deviceType, String deviceSubType, String make, String model) {
		...
		assertEquals(addDevicePage.isAddedDeviceTypeEnabled(deviceType), false);
		assertEquals(addDevicePage.isAddDeviceEnabled(), GlobalConstants.isAddDeviceButtonEnabled);
