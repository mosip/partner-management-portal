...
public class DatasharePolicyPage extends BasePage {
	...
	@FindBy(xpath = "//*[contains(text(), 'List of Datashare Policies')]")
	...
	@FindBy(xpath = "//*[contains(text(), 'By clicking ‘Publish,’ the policy - ')]")
	...
	@FindBy(xpath = "//*[contains(text(), 'Do you want to deactivate Policy -  'datashare ?'')]")
	private WebElement deactivatePolicyConfirmationPopup;
	...
	private WebElement deactivatePolicyCancelButton;
	
	@FindBy(id = "deactivate_policy_group__confirm_btn")
	private WebElement deactivatePolicyConfirmButton;
	...
	@FindBy(xpath = "//p[text()='ab11CD22ef']")
	...
	@FindBy(xpath = "//*[contains(text(), '\"attributeName\": \"fullName\",')]")
	...
	public boolean isViewDatasharePolicyPageTitleDisplayed() {
		return isElementDisplayed(viewDatasharePolicyPageTitle);
	}
	...
	public void clickOnDeactivatePolicyConfirmButton() {
		clickOnElement(deactivatePolicyConfirmButton);
	}
