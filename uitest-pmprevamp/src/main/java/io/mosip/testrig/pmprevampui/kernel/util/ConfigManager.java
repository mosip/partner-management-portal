...
public class ConfigManager {
	...
	public static void init() {
		...
		iam_pmprevamp_path =System.getenv(IAM_PMPREVAMP_PATH) == null
				? propsKernel.getProperty(IAM_PMPREVAMP_PATH)
						: System.getenv(IAM_PMPREVAMP_PATH);
		
		iam_pmprevamp =System.getenv(IAM_PMPREVAMP) == null
				? propsKernel.getProperty(IAM_PMPREVAMP)
		...
		randomPublicKey =System.getenv(RandomPublicKey) == null ? propsKernel.getProperty(RandomPublicKey) : System.getenv(RandomPublicKey);
