...
public class ListOfDevicesPage extends BasePage {
	...
	public boolean isDeviceStatusDisplayed(String deviceType, String deviceSubType, String make, String model, String status) {
	...
	public String getDeviceStatusClassValue(String deviceType, String deviceSubType, String make, String model, String status) {
		WebElement deviceStatus = driver.findElement(
				By.xpath("//td[text()='" + deviceType + "']/..//td[text()='" + deviceSubType + "']/..//td[text()='"
						+ make + "']/..//td[text()='" + model + "']/..//div[text()='" + status + "']"));
	...
	public void selectStatusFilter(String status) {
		...
		WebElement statusOption = driver.findElement(By.xpath("//button[contains(@id, 'device_list_filter_status_option') and text()='"+status+"']"));
