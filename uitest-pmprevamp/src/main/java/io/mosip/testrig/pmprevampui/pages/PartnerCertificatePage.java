...
public class PartnerCertificatePage extends BasePage {
	...
	@FindBy(xpath = "//p[contains(normalize-space(.), 'List of Root CA Certificates')]")
	...
	@FindBy(xpath = "//p[normalize-space(.)='/ List of Intermediate CA Certificates']")
	...
	public boolean isBreadcumbOfIntermediateCADisplayed() {
	...
	public boolean isToDateTimeFormatValid() {
	...
	public void clickOnBreadcumbOfIntermediateCA() {
